    ...
    <div class="py-12 bg-graybg">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="w-full flex justify-between items-center mb-6">
                ...
                <a href="{{ route('destinations.create') }}" class="py-2 px-4 bg-primary-600 text-white rounded-lg text-sm font-medium shadow-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                    Cadastrar Destino
                </a>
            </div>
                    ...
                    <div class="-m-1.5 overflow-x-auto">
                        <div class="p-1.5 min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                    <div class="flex gap-2 w-full justify-end">
                                                        <a href="{{ route('destinations.edit', $destination->id) }}" class="text-gray-900 decoration-0">
                                                        ...
                                                        <form id="delete-form-{{ $destination->id }}" action="{{ route('destinations.destroy', $destination->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>

                                                        <button class="text-gray-900 decoration-0" onclick="confirmDelete({{ $destination->id }})">
                                ...
                                <div class="m-4">
                                    {{ $destinations->links('vendor.pagination.custom-tailwind') }}
                                </div>
                            </div>
                        </div>
                    </div>
