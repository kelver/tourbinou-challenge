    ...
    <div class="py-12 bg-graybg">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="w-full flex justify-between items-center mb-6">
                ...
                <a href="{{ route('trips.create') }}" class="py-2 px-4 bg-primary-600 text-white rounded-lg text-sm font-medium shadow-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                    Cadastrar Passeio
                </a>
            </div>
                    ...
                    <div class="-m-1.5 overflow-x-auto">
                        <div class="p-1.5 min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                <div class="flex gap-2 w-full justify-end">
                                                    <a href="{{ route('trips.edit', $trip->id) }}" class="text-gray-900 decoration-0">
                                                    ...
                                                    <button class="text-gray-900 decoration-0" onclick="confirmDelete({{ $trip->id }})">
                                ...
                                <div class="m-4">
                                    {{ $trips->links('vendor.pagination.custom-tailwind') }}
                                </div>
                            </div>
                        </div>
                    </div>
